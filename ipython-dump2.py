...
ax.invert_yaxis()
ax.axis('off')
nx.draw(subG, pos=pos, node_size=1, edge_color='gray', with_labels=False, ax=ax)
plt.show()
get_ipython().run_line_magic('save', 'ipython-dump.py')
subG = G.subgraph(random.sample(list(G.nodes), 3000)).copy()
nx.draw(subG, pos=pos, node_size=1, edge_color='gray', with_labels=False, ax=ax)
plt.show()
nx.draw(subG, pos=pos, node_size=1, edge_color='gray', with_labels=False)
plt.show()
nx.draw(G, pos=pos, node_size=1, edge_color='gray', with_labels=False)
plt.show()
pos = coords_hires[:,[0,1]]
nx.draw(G, pos=pos, node_size=1, edge_color='gray', with_labels=False)
plt.show()
pos = coords_hires
nx.draw(G, pos=pos, node_size=1, edge_color='gray', with_labels=False)
